...
import com.example.warehouse.dto.UserFrontDto;
import com.example.warehouse.entity.User;
import com.example.warehouse.repository.UserRepository;
import com.example.warehouse.repository.UserWarehouseRepository;
...
public class UserController {
    ...
    final UserWarehouseRepository userWarehouseRepository;
    ...
    @PostMapping("/addUser")
    public String saveUser(@ModelAttribute UserDto userDto, HttpServletRequest req,
                           HttpServletResponse res){
        if (authService.deleteTokenIf(req, res)){return "secured-page";}
